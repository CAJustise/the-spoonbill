...
-- Drop all existing policies
DROP POLICY IF EXISTS "Authenticated users can view roles" ON admin_roles;
DROP POLICY IF EXISTS "Super admins can manage roles" ON admin_roles;
DROP POLICY IF EXISTS "Authenticated users can view permissions" ON admin_permissions;
DROP POLICY IF EXISTS "Super admins can manage permissions" ON admin_permissions;
DROP POLICY IF EXISTS "Authenticated users can view role permissions" ON admin_role_permissions;
DROP POLICY IF EXISTS "Super admins can manage role permissions" ON admin_role_permissions;
DROP POLICY IF EXISTS "Authenticated users can view user roles" ON admin_user_roles;
